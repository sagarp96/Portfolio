...
export const resume: Resume = {
	...
	about:
		"Software Engineer building scalable, type-safe applications.Insurance domain automation. Payment Integration, Realtime Collaboration, Testing and Data analytics.",
	skills: {
		techstack: [
			"React",
			"Tailwind CSS",
